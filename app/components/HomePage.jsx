      ...
      <div className="px-2 mx-2 mt-4 w-1/4">   
        <div className="mt-4">
          ...
          <div className="px-2 mx-2 my-2 text-center">
            <button className = "text-black-200 bg-purple-100"
        ...
        <div className="mt-4 bg-gray-100 p-4">
          <input type="text" name="search" placeholder="Search" onChange={handleFilterChange} className="block py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" />
        </div>
        {/* <div className="mt-4 bg-gray-100 p-4">
