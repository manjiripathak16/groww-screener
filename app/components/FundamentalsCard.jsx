...
export default function FundamentalsCard (props) {
  ...
  <div className="px-4 py-2">
    <h2 className="px-4 text-xl font-bold my-2">Company Name</h2>
    <div className="px-4 py-2">
      <span>{nse}</span>
    </div>
    <table className="w-full">
      <tbody>
        <tr>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Market Cap:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{marketCap}</td>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Current Price:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{currentPrice}</td>
        </tr>
        <tr>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Book Value:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{bookValue}</td>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">High Low:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{highLow}</td>
        </tr>
        <tr>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Stock P/E:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{stockPE}</td>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Roce:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{roce}</td>
        </tr>
        <tr>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Dividend Yield:</td>
          <td className="px-0 py-1 text-gray-600 text-sm">{dividendYield}</td>
          <td className="px-0 py-1 text-gray-600 text-sm font-semibold">Face Value:</td>
